...
const Encriptado = ({value, handleChange}) => {
	...
	return (
		<React.Fragment>
			...
			<Box sx={{}}>
				<Typography variant="body1" component="div" sx={{p: 3, backgroundColor:'#f5f5f5', borderRadius: '10px'}}>
...
export const View = () => {
	...
	return (
		<Box sx={{px: 1, py: 5}}>
			{activeStep === 0 ? (
				<TextoPlano value={textPlain} handleChange={handleTextPlain} handleReset={() => setTextPlain('')}/>
			) : activeStep === 1 ? (
